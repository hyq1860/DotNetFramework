...
<%@ Import Namespace="DotNet.Web.Configuration" %>
<%@ Import Namespace="DotNet.Web.StateManagement" %>
<script runat="server">
	...
	public override bool CheckAuthentication()
	{
        ...
        //校验文件上传权限 此处暂时改为true 正式需要修改
        string loginId = StateProvider.Current.GetStringValue(LoginCookieName.LoginId);
