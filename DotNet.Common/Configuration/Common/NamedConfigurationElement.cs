...
namespace DotNet.Common.Configuration
{
    ...
    /// </summary>
    /// <remarks>
    /// This class is used in conjunction with a <see cref="NamedConfigurationElementCollection"/>.
    /// </remarks>
    public class NamedConfigurationElement : ConfigurationElement, INamedObject
    {
        /// <summary>
