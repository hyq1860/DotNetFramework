...
namespace DotNet.Common
{
    ...
    public static class StringBuilderExtensions
    {
        ...
        /// <returns></returns>
        public static StringBuilder AppendValues<T>(this StringBuilder buf, string prefix, IEnumerable<T> values, string suffix, string delimiter) 
        {
            bool first = true;
            foreach (T val in values) 
            {
                ...
                buf.Append(prefix).Append(val.ToString()).Append(suffix);
            }
            return buf;
        }
    }
