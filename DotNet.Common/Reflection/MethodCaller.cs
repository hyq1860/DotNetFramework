...
namespace DotNet.Common.Reflection
{
    ...
    public static class MethodCaller
    {
        ...
        public static object CreateInstance(Type objectType)
        {
            ...
            if (ctor == null)
                throw new NotImplementedException("Default constructor Method Not Implemented.");
            return ctor.Invoke();
        }
        ...
        public static object CallMethod(object obj, MethodInfo info, params object[] parameters)
        {
            ...
            if (mh == null || mh.DynamicMethod == null)
                throw new NotImplementedException(info.Name + " Method Not Implemented.");
            return CallMethod(obj, mh, parameters);
        }
        ...
        private static object CallMethod(object obj, DynamicMethodHandle methodHandle, params object[] parameters)
        {
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception(methodHandle.MethodName + " Method Call Failed", inner);
            }
            return result;
        }
