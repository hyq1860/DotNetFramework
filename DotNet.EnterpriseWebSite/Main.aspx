<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="DotNet.EnterpriseWebSite.Main" %>
...
<script type="text/javascript">
    ...
    function addTab() {
        ...
        $.get("../Ajax/UserControlContainer.ashx?control=" + $(this).attr("control"), function (data) {
            $("#tabs2").tabpanel("add", { title: title, type: 'html', content: data ,initFn:function () {
        ...
        <div id="accordion">
	        <div class="group">
			    ...
			    <ul>
                    <li>
                        <div class="">
                            <a class="tab-link" title="新增产品" rel="ProductList.aspx" control="UserControls/ProductForm" ><span class="icon icon-users">&nbsp;</span><span class="nav">产品列表</span></a>
                        </div>
                    </li>
                    <li>
                        <div class="">
                            <a class="tab-link" title="产品列表" rel="ProductForm.aspx" control="UserControls/ProductList"  ><span class="icon icon-role">&nbsp;</span><span class="nav">新增产品</span></a>
                        </div>
                    </li> 
                    <li>
                        <div class="">
