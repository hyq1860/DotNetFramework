...
$.fn.themeswitcher = function(settings){
	...
	var switcherpane = $('<div class="jquery-ui-themeswitcher"><div id="themeGallery"><ul><li><a href="../jQueryUI/css/ui-lightness/jquery-ui-1.8.20.custom.css">						<span class="themeName">蓝色理想</span>		</a></li><li><a href="../jQueryUI/css/blitzer/jquery-ui-1.8.20.custom.css">						<span class="themeName">绿意盎然</span>		</a></li></ul></div></div>').find('div').removeAttr('id');
