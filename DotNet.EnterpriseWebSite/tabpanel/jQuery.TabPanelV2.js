...
;(function($) {
    ...
    var methods = {
        ...
        add:function (title,url) {
            ...
            iframe.attr("src", url).attr("id", "iframe-" + currentIndex);
    ...
    function initDefault(tabContainer) {
        ...
        tabContainer.append($(template.ulContainer).append(template.liItem));
        var pannelItemTemp = $(template.panelContainer);
        if (pannelItemTemp.hasClass("ui-tabs-hide")) {
            pannelItemTemp.removeClass("ui-tabs-hide");
        }
        tabContainer.append(pannelItemTemp.append(template.iframeItem));
    }
