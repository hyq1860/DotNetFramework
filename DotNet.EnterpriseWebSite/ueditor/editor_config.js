...
(function () {
    ...
    var tmp = window.location.pathname,
            URL = window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1)+"ueditor/";//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    UEDITOR_CONFIG = {
        ...
        labelMap:{
            ...
            'lineheight': '行间距', 'customstyle': '自定义标题', 'autotypeset': '自动排版', 'ckfinder': '文件管理'
        },
