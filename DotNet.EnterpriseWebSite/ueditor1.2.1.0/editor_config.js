...
(function () {
    ...
    var tmp = window.location.pathname;
        URL = '../ueditor1.2.1.0/';//window.UEDITOR_HOME_URL||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        , imageManagerPath: "../upload/" + "images/"                                    //图片修正地址，同imagePath
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'print', 'preview', 'searchreplace', 'help', 'ckfinder']
        ]
        ...
        ,labelMap:{
            ...
            'lineheight':'行间距', 'customstyle':'自定义标题','autotypeset': '自动排版','webapp':'百度应用', 'ckfinder': '文件管理'
        }
