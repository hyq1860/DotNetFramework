<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index3.aspx.cs" Inherits="DotNet.Web.BackstageManagement.Index3" %>
...
<script type="text/javascript">
 ...
 function addTab(){
     ...
     var iframe = '<iframe scrolling="auto" frameborder="0" id="container"  src=' + src + ' style="width:100%;height:100%;"></iframe>';
     $('<div id="new-tab-' + tabCounter + '">' + iframe + '</div>').appendTo('#tabs');
     // 添加tabs
     $('#tabs').tabs("add", "#new-tab-" + tabCounter, 'New tab' + tabCounter);
     //选中新建的tabs
     $('#tabs').tabs('select', '#' + 'new-tab-' + tabCounter);
     tabCounter++;
}
