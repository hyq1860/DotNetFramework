    ...
    public class WebPage
    {
        ...
        public string SaveHtmlAndResource(string fileName, bool ignoreScript, DirConfig dirConfig)
        {
            ...
            htmlContent = RegexCollection.RegCssLink.Replace(htmlContent, delegate(Match match)
            {
                ...
                return this.MatchUrl(match,dirConfig, this.pageUrl, dirConfig.HtmlDirPath, dirConfig.CssDirPath, "src", null, delegate(string cssUrl)
                {
                    //css内容、css保存路径
                    ...
                    if (cResponse.Success)
                    {
                        ...
                        {
                            //确定css文件保存的绝对路径
                            cssSavePath = dirConfig.UseWebSite ? Path.GetFullPath(PathUtility.GetSaveDir(this.PageUrl, cssUrl, dirConfig.HtmlDirPath) + cResponse.GetFileName()) : Path.GetFullPath(dirConfig.CssDirPath + "\\" + cResponse.GetFileName());
                            //获取css内容
                            ...
                            //将css保存到本地
                            cssSavePath = FileUtility.SaveText(cssSavePath, cssContent, cResponse.GetEncoding());
            ...
            {
                return this.MatchUrl(match, dirConfig, this.pageUrl, dirConfig.HtmlDirPath, dirConfig.JsDirPath, "src", null, null);
            });
            #endregion
            ...
            {
                return this.MatchUrl(match, dirConfig, this.pageUrl, dirConfig.HtmlDirPath, dirConfig.ImgDirPath, "src", null, null);
            });
            #endregion
            ...
            {
                return this.MatchUrl(match, dirConfig, this.pageUrl, dirConfig.HtmlDirPath, dirConfig.FlashDirPath, "src", null, null);
            });
            #endregion

            #region 当前页面内嵌css中的图片
            htmlContent = this.ReplaceBackgroundUrl(htmlContent, this.PageUrl, dirConfig, dirConfig.HtmlDirPath, dirConfig.ImgDirPath, false, null);
            #endregion
        ...
        public string AsyncSaveHtmlAndResource(string fileName, bool ignoreScript, DirConfig dirConfig)
        {
            ...
            htmlContent = RegexCollection.RegScriptLink.Replace(htmlContent, delegate(Match match)
            {
                return this.MatchUrl(match, dirConfig, this.pageUrl, dirConfig.HtmlDirPath, dirConfig.JsDirPath, "src", null, null, true, dic);
            });
            #endregion
            ...
            htmlContent = RegexCollection.RegImg.Replace(htmlContent, delegate(Match match)
            {
                return this.MatchUrl(match, dirConfig, this.pageUrl, dirConfig.HtmlDirPath, dirConfig.ImgDirPath, "src", null, null, true, dic);
            });
            #endregion
            ...
            htmlContent = RegexCollection.RegFlash.Replace(htmlContent, delegate(Match match)
            {
                return this.MatchUrl(match, dirConfig, this.pageUrl, dirConfig.HtmlDirPath, dirConfig.FlashDirPath, "src", null, null, true, dic);
            });
            #endregion

            #region 当前页面内嵌css中的图片
            htmlContent = this.ReplaceBackgroundUrl(htmlContent, this.PageUrl, dirConfig, dirConfig.HtmlDirPath, dirConfig.ImgDirPath, true, dic);
            #endregion
