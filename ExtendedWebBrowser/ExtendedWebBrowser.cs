// -----------------------------------------------------------------------
// <copyright file="ExtendedWebBrowser.cs" company="">
...
namespace ExtendedWebBrowser2
{
    ...
    /// http://www.codeproject.com/Articles/13598/Extended-NET-2-0-WebBrowser-Control#ConclusionSample
    /// http://www.cnblogs.com/tanjian/articles/1633226.html
    /// </summary>
    public class ExtendedWebBrowser : WebBrowser, UnsafeNativeMethods.IOleCommandTarget, UnsafeNativeMethods.IObjectWithSite
    {
        ...
        #region 设置 Controlling Download and Execution
        //http://msdn.microsoft.com/en-us/library/aa770041%28VS.85%29.aspx
         ...
         *you need to implement IOleCommandTarget on the host 
         *and pass it to the browser via an overridden CreateWebBrowserSiteBase method 
         */
        ...
        public int DownloadControlFlags
        {
            ...
            set
            {
                ...
                //IOleControl ctl = (IOleControl)this.ActiveXInstance;
                var ctl = this.ActiveXInstance as IOleControl;
                if(null!=ctl)
                {
        ...
        class WebBrowserExtendedEvents : StandardOleMarshalObject, UnsafeNativeMethods.DWebBrowserEvents2
        {
        ...
        #region IOleCommandTarget Impl

        public int QueryStatus(IntPtr pguidCmdGroup, uint cCmds, ref tagOLECMD prgCmds, IntPtr pCmdText)
        {
        ...
        public event ScriptErrorEventHandler ScriptError = null;
